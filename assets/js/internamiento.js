document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("btnAgregarEquipo").addEventListener("click", () => {
    ...
    `;
    document
      .getElementById("equiposBody")
      .insertAdjacentHTML("beforeend", fila);
  });

  // Eliminar fila
  document
    .getElementById("tablaEquipos")
  ...
  // Enviar formulario
  document
    .getElementById("btnGuardarInternamiento")
      ...
      document
        ...
        .addEventListener("click", () => {
          ...
          if (dniRuc === "") {
            Swal.fire(
              "Advertencia",
              "Ingresa un DNI o RUC para buscar.",
              "warning"
            );
            return;
          }
