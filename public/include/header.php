...
<head>
    ...
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/icon-kit/dist/css/iconkit.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/ionicons/dist/css/ionicons.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/perfect-scrollbar/css/perfect-scrollbar.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/weather-icons/css/weather-icons.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/c3/c3.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/owl.carousel/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/plugins/owl.carousel/dist/assets/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?= URL_WEB ?>/public/dist/css/theme.min.css">
    <script src="<?= URL_WEB ?>/public/src/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="page-wrap">
            <div class="app-sidebar colored">
                <div class="sidebar-header">
                    <a class="header-brand" href="index.php">
                        <div class="logo-img">
                            <img src="<?= URL_WEB ?>/public/img/logo/logoBlanca.png" class="header-brand-img" alt="lavalite"
                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item">
                                <a href="<?= URL_WEB?>/views/"><i class="fas fa-plus"></i><span>Registrar Equipos</span> <span
                                        class="badge badge-success"></span></a>
                            </div>
                            <div class="nav-item">
                                <a href="clientes.php"><i class="fas fa-user"></i><span>Clientes</span> <span
                                        class="badge badge-success"></span></a>
                            </div>
                            <div class="nav-item">
                                <a href="equipos.php"><i class="fas fa-laptop"></i><span>Equipos</span> <span
                                        class="badge badge-success"></span></a>
                            </div>
                            <div class="nav-item">
                                <a href="roles/"><i class="fas fa-user-cog"></i>
            ...
            <!--INICIO opciones de icono cuadrado -->
            ...
            <!--FIN opciones de icono cuadrado -->


            <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
            <script>
                window.jQuery || document.write('<script src="<?= URL_WEB ?>/public/src/js/vendor/jquery-3.3.1.min.js"><\/script>')
            </script>
            <script src="<?= URL_WEB ?>/public/plugins/popper.js/dist/umd/popper.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/screenfull/dist/screenfull.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/datatables.net/js/jquery.dataTables.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/jvectormap/jquery-jvectormap.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/jvectormap/tests/assets/jquery-jvectormap-world-mill-en.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/moment/moment.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/d3/dist/d3.min.js"></script>
            <script src="<?= URL_WEB ?>/public/plugins/c3/c3.min.js"></script>
            <script src="<?= URL_WEB ?>/public/js/tables.js"></script>
            <script src="<?= URL_WEB ?>/public/js/widgets.js"></script>
            <script src="<?= URL_WEB ?>/public/js/charts.js"></script>
            <script src="<?= URL_WEB ?>/public/dist/js/theme.min.js"></script>
